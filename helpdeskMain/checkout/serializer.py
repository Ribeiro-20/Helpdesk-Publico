...
class ResumoApresentadoSerializer(serializers.Serializer):
...
class PedidoPagamentoSerializer(serializers.Serializer):
    ...
    resumo_apresentado = ResumoApresentadoSerializer()