...
function buildHref(page: number, params: SearchParams): string {
  ...
  params.act_type.forEach((value) => qp.append("act_type", value));
  params.model.forEach((value) => qp.append("model", value));
  params.procedure?.forEach((value) => qp.append("procedure", value));
  params.contract_type?.forEach((value) => qp.append("contract_type", value));
