    ...
    <footer className="bg-[#1a1b1f] px-4 py-12 text-gray-300 sm:px-6 lg:px-12 lg:py-16">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-12 md:flex-row md:justify-between md:gap-6">
          ...
          {/* Adicionado items-center para centrar no mobile, md:items-start para alinhar à esquerda no PC */}
          <div className="flex flex-col items-center md:items-start gap-6 w-full md:w-auto">
            ...
            {/* Adicionado justify-center para o mobile e md:justify-start para o PC */}
            <div className="flex items-center justify-center md:justify-start gap-4 text-[#80889a] w-full">
              <Link
            ...
            <div className="mt-2 border-t border-gray-800 pt-4 w-full text-center md:text-left">
