            ...
            {step === "login" ? (
              <form onSubmit={handleLogin} className="space-y-5 relative z-10">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-2xl transition-all disabled:opacity-50 text-sm shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 active:scale-[0.98]"
                >
              ...
              <form onSubmit={handleVerify} className="space-y-6 relative z-10">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      autoFocus
                      className="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-2xl tracking-[0.5em] text-center focus:ring-2 focus:ring-emerald-500/20 transition-all font-black text-slate-900"
                      placeholder="000000"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-2xl transition-all disabled:opacity-50 text-sm shadow-lg shadow-emerald-500/20 active:scale-[0.98]"
                  >
